                ...
                <div class="container py-5">
                    <div class="row g-5 align-items-center">
                        <div class="col-md-12 col-lg-5">
                            <img src="img/homeImage/sofa1.jpg" class="img-fluid w-100 h-150 bg-secondary rounded" alt="First slide" />
                        </div>
                        <div class="col-md-12 col-lg-7">
                            <h1 class="mb-4 display-5 text-dark">HOME IS THE SOURCE OF ALL HAPPINESS</h1>
                            <p>DEAR
